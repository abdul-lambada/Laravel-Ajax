<!-- Modal -->
<div class="modal fade" id="modal-edit" tabindex="-1" aria-label="exampleModalLabel" aria-hidden="true">
                ...
                let post = `
                    <tr id="index_${response.data.id}">
                        ...
                        <td class="text-center">
                            <a href="javascript:void(0)" id="bn-edit-post" data-id="${response.data.id}" class="btn btn-primary btn-sm">EDIT</a>
                            <a href="javascript:void(0)" id="tbn-delete-post" data-id="${response.data.id}" class="btn btn-danger btn-sm">DELETE</a>
                        </td>
                    </tr>
                `;

                //append to post data
                $(`#index_${response.data.id}`).resplaceWith(post);
